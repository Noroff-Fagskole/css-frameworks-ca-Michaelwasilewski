...
function createHeaderBar() {
    ...
    if (navBar) {
        ...
        let navLinks;
         navLinks = `
            <li><a href="/index.html" class="${pathname === "/index.html" ? "text-blue-600" : ""}">SignUp</a></li>
            <li><a href="/login.html" class="${pathname === "/login.html" ? "text-blue-600" : ""}">LogIn</a></li>
            `;
        if (userName) {
            navLinks = `
            <li>
                <a href="/home.html" class="${pathname === "/home.html" ? "text-white" : ""} block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Home</a>
            </li>
            <li >
                <a href="/create-post.html" class="${pathname === "/create-post.html" ? "" : ""}block py-2  text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"><svg
            ...
            <li>
                <a href="/profile.html" class="${pathname === "/profile.html" ? "" : ""} block py-2 pr-4 pl-3 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">My Posts</a>
            </li>
